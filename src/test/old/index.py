...
def main_indexing(mypath):
    ...
    for file in onlyfiles:
        ...
        if file_already_indexed(es, "search-my_elastic", file_name, file_url):
        ...
        embeddings = hf.embed_documents(file_content)
        ...
        es.index(index="search-my_elastic-whole", document=doc_body)
